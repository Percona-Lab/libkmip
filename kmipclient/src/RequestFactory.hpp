...
public:
  ...
  static void create_register_secret_rq (KmipCtx &ctx, const name_t &name, const name_t &group,
                                         const std::string_view &secret, int secret_data_type);
  ...
  static void create_locate_by_name_rq (KmipCtx &ctx, const name_t &name, object_type o_type, size_t max_items,
                                        size_t offset);
  static void create_locate_by_group_rq (KmipCtx &ctx, const name_t &group_name, object_type o_type, size_t max_items,
                                         size_t offset);
  static void create_locate_all_rq (KmipCtx &ctxm, object_type o_type, size_t max_items, size_t offset);

private:
  static void create_locate_rq (KmipCtx &ctx, bool is_group, const name_t &name, object_type o_type, size_t max_items,
                                size_t offset);
};
