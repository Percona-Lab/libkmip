...
NetClientOpenSSL::NetClientOpenSSL (const std::string host, const std::string port, const std::string clientCertificateFn,
                                    const std::string clientKeyFn, const std::string serverCaCertFn, int timeout_ms)
